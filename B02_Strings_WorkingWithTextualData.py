...
print(
    message.count("Hello")
)  # To count certain number of char in the string.Use count method.This method takes string as a argument
...
)  # To find the index of char does not exists will get negative index
